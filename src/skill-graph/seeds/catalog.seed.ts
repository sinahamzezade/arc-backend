...
export const CATALOG_SEED: {
  ...
  resources: [
    ...
    },
    {
      ...
      resourceType: 'docs',
      techStackSlugs: ['testing-library'],
    },
    {
      slug: 'w3schools-sql',
      title: 'SQL Tutorial',
    ...
    },
    {
      ...
      skillTags: ['marketing-seo'],
      techStackSlugs: ['marketing-seo'],
    },
    {
      slug: 'chartjs-docs',
  ...
  stacks: [
      ...
      skills: [
        {
          ...
          lessons: [
            ...
            L(
              'es6-practice',
              'Rewrite scripts with modern syntax',
              'practice',
              40,
              65,
              ['doing'],
    ...
    },
    {
      ...
      skills: [
        ...
        },
        {
          ...
          estimatedHours: 5,
          tags: [],
          prereqSlugs: ['types-basics', 'react:components'],
          lessons: [
            L(
              'rts-video',
              'Typing props and hooks',
              'video',
              22,
              35,
              ['videos'],
      ...
      skills: [
        {
          ...
          lessons: [
            ...
            L(
              'ctl-video',
              'Accessible queries walkthrough',
              'video',
              18,
              30,
              ['videos'],
    ...
    },
    {
      ...
      skills: [
        {
          slug: 'fe-system-design-lite',
          title: 'FE System Design Lite',
          orderHint: 1,
          estimatedHours: 5,
          tags: [],
          lessons: [
        ...
        },
        {
          ...
          lessons: [
            ...
            L(
              'cq-practice',
              'Answer five FE questions aloud',
              'practice',
              35,
              55,
              ['doing'],
      ...
      skills: [
        {
          ...
          lessons: [
            ...
            L(
              'select-practice',
              'Filter and sort a sample table',
              'practice',
              35,
              55,
              ['doing'],
      ...
      skills: [
        {
          ...
          lessons: [
            L(
              'story-read',
              'Insight → recommendation structure',
              'reading',
              20,
              35,
              ['reading'],
  ...
  recipes: [
    {
      ...
      summary:
        'HTML/CSS and JS foundations, React core, optional advanced stack, then portfolio and interviews.',
    ...
    },
    {
      ...
      summary:
        'Excel and SQL foundations, Python and visualization core, optional storytelling soft skills.',
      defaultTimelineWeeks: 24,
      phases: [
        {
          key: 'foundations',
          title: 'Foundations',
          tech_stack_slugs: ['excel', 'sql'],
          required: true,
        },
        {
          key: 'core',
          title: 'Analysis Core',
          tech_stack_slugs: ['python', 'data-viz'],
          required: true,
        },
        {
          key: 'soft',
          title: 'Communication',
          tech_stack_slugs: ['communication'],
          required: false,
          include_if_confidence_gte: 'somewhat',
        },
      ],
    },
    {
      ...
      summary:
        'JavaScript language core, Python services, and SQL data layer for API-focused backends.',
      defaultTimelineWeeks: 24,
      phases: [
        {
          key: 'language-core',
          title: 'Language Core',
          tech_stack_slugs: ['javascript'],
          required: true,
        },
        {
          key: 'services',
          title: 'Services & Scripting',
          tech_stack_slugs: ['python'],
          required: true,
        },
        {
          key: 'data-layer',
          title: 'Data Layer',
          tech_stack_slugs: ['sql'],
          required: true,
        },
      ],
    },
    {
      ...
      summary:
        'SEO fundamentals, clear communication, and light data visualization for campaigns.',
      defaultTimelineWeeks: 20,
      phases: [
        {
          key: 'seo',
          title: 'SEO Foundations',
          tech_stack_slugs: ['marketing-seo'],
          required: true,
        },
        {
          key: 'comms',
